...
const Navbar = () => {
    ...
    return (
        <>
            {/* NAVBAR PRINCIPALE */}
            <header className="fixed w-full top-0 z-50 bg-stone-50/70 backdrop-blur-md border-b border-stone-200/40 transition-all duration-300">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
                    ...
                    <nav className="flex items-center gap-6 text-sm font-medium">
                        ...
                        <a href="#servizi" className="hidden md:inline text-stone-500 hover:text-stone-900 transition-colors relative py-1 group">
                            Servizi
                            <span className="absolute bottom-0 left-0 w-0 h-[1px] bg-stone-900 transition-all group-hover:w-full" />
                        </a>
                        <a href="#metodo" className="hidden md:inline text-stone-500 hover:text-stone-900 transition-colors relative py-1 group">
                            Metodo
                            <span className="absolute bottom-0 left-0 w-0 h-[1px] bg-stone-900 transition-all group-hover:w-full" />
                        </a>
                        ...
                        <motion.button
                            ...
                            className="bg-stone-950 text-stone-50 px-4 py-2 text-xs sm:text-sm font-medium rounded-full shadow-sm transition-colors"
                        >
                            Crea il tuo CV
                        </motion.button>
